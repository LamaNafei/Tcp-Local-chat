...
def receive():
    ...
    while True:
        ...
        client.send(f'you are now connected \n if you want to talk private you should start your message (private to id//message)\n if you want to talk groups start your message (group with // message)\ndo not forget to write exit when you want left private and group chating'.encode('utf-8'))
